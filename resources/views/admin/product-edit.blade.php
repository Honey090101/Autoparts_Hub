...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update') }}">
            ...
            <div class="wg-box">
                <fieldset>
                    <div class="body-title">Current Image <span class="tf-color-1">*</span></div>
                    <div class="upload-image flex-grow mb-20">
                        <div class="item">
                            <img src="{{ asset('uploads/products/' . $product->image) }}" class="effect8" alt="{{ $product->name }}" style="max-width: 300px;">
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="upload-image mb-16 flex">
                        @foreach(explode(',', $product->images) as $galleryImage)
                        <div class="item mr-3">
                            <img src="{{ asset('uploads/products/' . $galleryImage) }}" class="effect8" alt="Gallery Image" style="max-width: 100px;">
                        </div>
                        @endforeach
                    </div>
                    @endif
                    
                    <div class="body-title mb-10">Upload New Gallery Images</div>
...
<script>
    $(function() {
        ...
        $("#gFile").on("change", function(e) {
            ...
            $("#galUpload").empty(); // Clear previous images
        ...
        $("input[name='name']").on("input", function() {
            $("input[name='slug']").val(stringToSlug($(this).val())); // Set slug based on name input
        });
